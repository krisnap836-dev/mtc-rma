...
function TodoPage({ todos, setTodos, toast, theme }) {
  ...
  return (
    <div style={{ display:"flex", flexDirection:"column", gap:20 }}>
      ...
      <div style={cardStyle}>
        <h3 style={{ color: T.text, fontWeight:600, fontSize:15, margin:"0 0 4px" }}><Bell size={16} style={{display:"inline",verticalAlign:"-3px",marginRight:6}}/>Notifikasi WhatsApp</h3>
        ...
        <div style={{ display:"flex", gap:10, marginTop:20 }}>
          <BtnPrimary onClick={saveSettings}><Save size={14} style={{display:"inline",verticalAlign:"-2px",marginRight:6}}/>Simpan Pengaturan</BtnPrimary>
          <BtnSecondary onClick={testNotif} theme={T}><Send size={14} style={{display:"inline",verticalAlign:"-2px",marginRight:6}}/>Test Kirim Notif</BtnSecondary>
        </div>
      </div>
