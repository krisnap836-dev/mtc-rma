...
const SEED_ACTIVITIES = [
  ...
  { id: "a2", date: "2025-06-08", plant: "PLANT 2", shift: "Siang", type: "Preventive", machine: "Kompresor B", description: "Cek tekanan, drain kondensasi, kalibrasi", status: "Selesai", duration: 1 },
  { id: "a3", date: "2025-06-07", plant: "PLANT 1 KRW", shift: "Pagi", type: "Corrective", machine: "Pompa Hidrolik G", description: "Ganti seal, flush sistem, test pressure", status: "Proses", duration: 4 },
];
        ...
        return (
          <div key={shift}>
            ...
            <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fill, minmax(320px, 1fr))", gap:12 }}>
              {items.map(a => (
                <div key={a.id} style={{ background: T.card, backdropFilter: T.blur, WebkitBackdropFilter: T.blur, boxShadow: T.shadow, border:`1px solid ${T.cardBorder}`, borderRadius:14, padding:16, display:"flex", flexDirection:"column", gap:12, transition:"all 0.3s ease" }}>
                  <div style={{ display:"flex", alignItems:"flex-start", justifyContent:"space-between", gap:8 }}>
                    <div style={{ flexShrink:0, width:44, height:44, borderRadius:12, display:"flex", alignItems:"center", justifyContent:"center", background: a.type === "Preventive" ? "rgba(16,185,129,0.15)" : "rgba(239,68,68,0.15)", color: a.type === "Preventive" ? "#10b981" : "#ef4444" }}>
                      {(() => { const TI = tIcons[a.type] || ClipboardList; return <TI size={20}/>; })()}
                    </div>
                  ...
                  <div style={{ display:"flex", flexDirection:"column", gap:8 }}>
                    <div>
                      <div style={{ color: T.text, fontWeight:600, fontSize:14, marginBottom:2 }}>{a.machine}</div>
                      <div style={{ color: T.textSub, fontSize:12 }}>{a.description}</div>
                    </div>
                    
                    <div style={{ display:"flex", flexWrap:"wrap", gap:6, paddingTop:8, borderTop:`1px solid ${T.divider}` }}>
                  ...
                  {canEdit && (
                    <div style={{ display:"flex", gap:6, paddingTop:8, borderTop:`1px solid ${T.divider}` }}>
                      <button 
                        onClick={() => editActivity(a)} 
                        style={{ flex:1, padding:"8px 12px", borderRadius:8, fontSize:12, color:"#3b82f6", background:"rgba(59,130,246,0.1)", border:"1px solid rgba(59,130,246,0.2)", cursor:"pointer", fontWeight:500 }}>
                        ✏️ Edit
                      </button>
                      <button 
                        onClick={() => remove(a.id)} 
                        style={{ flex:1, padding:"8px 12px", borderRadius:8, fontSize:12, color:"#ef4444", background:"rgba(239,68,68,0.1)", border:"1px solid rgba(239,68,68,0.2)", cursor:"pointer", fontWeight:500 }}>
                        🗑️ Hapus
                      </button>
                    </div>
                  )}
